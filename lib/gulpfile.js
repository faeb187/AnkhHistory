...
gulp.task('bundle', function() {
  ...
  return gulp.src('*.js', {
    read: false
  }).pipe(shell(['browserify app.js ' + '-r ./network/adapters/apollo ' + '-o ./app.min.js']));
});

gulp.task('default', gulp.series("network", "uis", "helpers", "pug", "styl", "conf", "designs", "sites", "coffee", "bundle"), (done) => {
  return done();
});
